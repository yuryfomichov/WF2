...
class StackingModel(nn.Module):
    def __init__(self, num_classes=2):
        ...
        self.model2 = self._get_model(CombinedModel, "model2.pt")
        self.model3 = self._get_model(FeaturesModel, "model3.pt")
        self.model4 = self._get_model(FeaturesModel, "model4.pt")
