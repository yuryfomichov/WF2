...
def run():
    ...
    network.train(loss_fn, optim.Adam(network.model.parameters(), lr=1e-5, weight_decay=1e-3), num_epochs=10)
    network.train(loss_fn, optim.Adam(network.model.parameters(), lr=1e-6, weight_decay=1e-3), num_epochs=10)
